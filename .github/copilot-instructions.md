...
## Purpose
This repository contains the shared core types, contracts, and utilities used across the Mogami x402 stack.

It is the foundation layer shared by multiple repositories such as client, server starter, facilitator, console, and
examples.

Changes made here have a high blast radius.
